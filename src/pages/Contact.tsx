...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen">
      <section className="relative overflow-hidden py-22 lg:py-40">
        <div className="absolute inset-0 z-0">
          <img src={contactBg} alt="" width={1920} height={1280}  loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover" />
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <a href="mailto:info@connectspeech.com" className="flex items-center gap-4 group">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">info@xxxxxxxxxx.com</p>
                  </div>
                </a>
              ...
              <div className="mt-8 rounded-xl overflow-hidden border border-border/50 aspect-video">
                <iframe
                  ...
                  src="https://www.google.com/maps?q=Kannur,Kerala,India&output=embed"
                  loading="lazy"
