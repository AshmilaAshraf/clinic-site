    ...
    <div className="min-h-screen">
      ...
      <section className="relative overflow-hidden py-20 lg:py-32">
        <div className="absolute inset-0 z-0">
          <img src={heroClinic} alt="Calming speech therapy clinic interior" width={1920} height={1280} loading="eager" fetchPriority="high" decoding="async" className="w-full h-full object-cover" />
          ...
          <div className="max-w-2xl">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
                ...
                <Link to="/services">
                  <Button variant="outline" size="lg" className="text-base font-semibold px-8 py-6 rounded-xl bg-background/80 backdrop-blur">
                    Our Services
                  </Button>
                </Link>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={0}>
              <div className="rounded-2xl aspect-[4/3] overflow-hidden shadow-xl">
                <img src={therapistImg} alt="Axxxx Xxxxx Xxxxxx, Speech Therapist" loading="lazy" width={1024} height={1024} className="w-full h-full object-cover" />
              </div>
            </motion.div>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp} custom={1}>
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Led by <strong className="text-foreground">Axxxx Xxxxx Xxxxxx (BASLP)</strong>, a qualified Speech Therapist, our therapy programs focus on personalized care, evidence-based techniques, and creating a comfortable environment for patients and families.
              </p>
              <Link to="/about">
      ...
      <section className="relative overflow-hidden py-16 lg:py-24 bg-gradient-to-br from-accent/50 via-background to-secondary/40">
        ...
        <div className="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-[hsl(195,55%,55%)]/15 blur-3xl pointer-events-none" />
        <div className="container mx-auto px-4 relative z-10">
          ...
          <div className="grid sm:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {symptoms.map((symptom, i) => (
              <motion.div
                ...
                variants={fadeUp}
                custom={i}
                className="flex items-start gap-3 bg-card/80 backdrop-blur-sm p-4 rounded-xl border border-border/50 shadow-sm hover:shadow-md hover:border-primary/30 transition-all"
              >
      ...
      {/* Stats */}
      <section className="py-16 lg:py-24 bg-gradient-to-br from-primary via-primary to-[hsl(174,65%,30%)] relative overflow-hidden">
        <div className="absolute inset-0 opacity-10 pointer-events-none" style={{ backgroundImage: "radial-gradient(circle at 20% 20%, white 1px, transparent 1px), radial-gradient(circle at 80% 70%, white 1px, transparent 1px)", backgroundSize: "60px 60px" }} />
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-12">
            <p className="text-primary-foreground/80 font-semibold text-sm uppercase tracking-wider mb-2">Our Impact</p>
            <h2 className="font-heading text-3xl lg:text-4xl font-bold text-primary-foreground">Trusted by Many Families</h2>
          </div>
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6">
            <StatCounter variant="onPrimary" end={1000} label="Therapy Sessions Conducted" />
            <StatCounter variant="onPrimary" end={500} label="Happy Patients" />
            <StatCounter variant="onPrimary" end={5} suffix="+" label="Years of Experience" />
            <StatCounter variant="onPrimary" end={100} suffix="%" label="Personalized Plans" />
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8">
            ...
            <a href="mailto:info@connectspeech.com" className="flex items-center gap-2 text-foreground hover:text-primary transition-colors">
              <Mail size={20} /> <span className="font-medium">info@xxxxxxxxxx.com</span>
            </a>
            <div className="flex items-center gap-2 text-foreground">
              <MapPin size={20} /> <span className="font-medium">Kerala, India</span>
            </div>
          </div>
        </div>
      </section>
