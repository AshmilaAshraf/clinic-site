      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            <div className="w-10 h-10 rounded-xl bg-accent flex items-center justify-center p-1">
              <img src={logo} alt="Connect Speech logo" width={40} height={40} className="w-full h-full object-contain" />
            </div>
