        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-xl bg-primary-foreground/10 flex items-center justify-center p-1">
                <img src={logo} alt="" width={40} height={40} className="w-full h-full object-contain rounded-xl" />
              </div>
              <div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="mailto:info@connectspeech.com" className="flex items-center gap-2 text-sm opacity-70 hover:opacity-100 transition-opacity">
                <Mail size={16} />info@xxxxxxxxxx.com
              </a>
